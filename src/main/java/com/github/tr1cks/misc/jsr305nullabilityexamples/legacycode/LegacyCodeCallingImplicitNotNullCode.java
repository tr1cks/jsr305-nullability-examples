...
import com.github.tr1cks.misc.jsr305nullabilityexamples.newcode.ImplicitNotNullCode;

import javax.annotation.Nullable;
import java.util.Random;

public class LegacyCodeCallingImplicitNotNullCode {
    private ImplicitNotNullCode newCode;
